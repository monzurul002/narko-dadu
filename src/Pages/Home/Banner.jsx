            ...
            <div id="banner" className="text-white pt-20 w-11/12 mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-8">
                    <div className="col-span-4 space-y-6 relative">
                        <div className="flex justify-center relative">
                            <img src={etheriam} width="40px" className="my-2 animate-spin-slow hidden lg:flex" alt="" />
                            <img src={circle} className="absolute left-[-30px] top-52" alt="" />
                        </div>
                        <img src={hero} className=" w-20 md:w-32   animate-spin-slow absolute right-[-10px] md:right-[-20px] top-20 md:top-32" alt="" />
                        <h1 className="text-5xl md:text-7xl font-bold px-5 ">Supercharge your NFT Adventure</h1>
                        <p className="text-xl px-4 md:px-0">Find the right NFT collections to buy within the platform.</p>
                    ...
                    <div style={{ backgroundImage: `url(${bg})`, backgroundRepeat: "no-repeat" }} className="col-span-3 relative">
                        ...
                        <div className="flex gap-4 absolute top-5 md:top-20  md:flex-row flex-col ml-1 md:ml-14 right-0">
                            <img src={art} className=" w-full md:w-72 rounded-3xl" alt="" />
                            <img src={art2} className="w-full md:w-72 rounded-3xl" alt="" />
                        </div>
                    </div>
                </div>
                ...
                <div className="text-center py-16 space-x-8 mt-[600px] lg:mt-5">
                    ...
                    <div className="grid grid-cols-5 gap-8">
                        ...
                        <div className="flex gap-2">
                            <img src={coinbase} className="w-full md:w-2/3" alt="" />

                        </div>
                        <div className="flex gap-2">
                            <img src={trust} className="w-full md:w-2/3  mt-2" alt="" />
